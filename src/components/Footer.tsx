...
const Footer = () => (
  <footer className="bg-rose-surface-2 pt-16 pb-8">
    <div className="max-w-content mx-auto px-6 text-center md:text-left">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          <div className="flex flex-col gap-3 font-body text-sm text-rose-ink-secondary items-center md:items-start">
